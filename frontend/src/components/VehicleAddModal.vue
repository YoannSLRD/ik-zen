        ...
        <div class="modal-body">
          <form @submit.prevent="handleSubmit">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" v-model="newVehicle.vehicle_type" required>
...
const emit = defineEmits(['vehicle-added', 'close']);
const toast = useToast();
const modalElement = ref(null);
let modalInstance = null;
const loading = ref(false);
const newVehicle = ref({ name: '', fiscal_power: '', vehicle_type: 'car' });
...
const show = () => {
  newVehicle.value = { name: '', fiscal_power: '', vehicle_type: 'car' };
  modalInstance?.show();
};
